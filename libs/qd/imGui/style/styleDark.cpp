...
void imGuiApplyStyleDark()
{
    ...
    colors[ImGuiCol_TitleBgActive] = ImColor(0.06f, 0.06f, 0.06f, 1.00f);
    ...
    colors[ImGuiCol_HeaderHovered] = ImColor(62, 62, 62);
    ...
    style.DisplayWindowPadding.x = 8;
    style.DisplayWindowPadding.y = 8;
