#include "uiNode.h"
#include "qd/qdDebug/exception.h"
#include "qd/qdMem/ptrMath.h"
#include "qd/qdUI/uiMessages.h"
...
qd::UiNode* UiNode::addChild(ref_ptr<UiNode> pChild)
{
    ...
    {
        qd::string err =
            qd::stringFormat("AddChild - Exception: Child already added to Parent Control! id=\"%i\" ", id);
