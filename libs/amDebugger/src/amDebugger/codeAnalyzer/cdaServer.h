...
public:
    void requestAnalyzedBlock(amD::AbsEmu* vm, AddrRef addr, int nItems, qd::vector<amD::cda::Item *> *outItems, const AddrRef* pCheckAddr = nullptr);

    CodeChunk &requestCodeChunk(amD::AbsEmu *vm, AddrRef addr);
